...
% typed backend
\resumeSubheading
{Business Canvas(Typed)}{2022.06 -- Present}
...
\resumeItemListStart
  ...
  \resumeItem{사내 데이터 플랫폼 개발 및 운영}
    \resumeItemListStart
    \resumeItem{Airflow를 활용한 data orchestration. data ETL, reverseETL 관리}
      ...
      \resumeItem{Event taxonomy 관리를 위해 kaitai를 활용한 markup to validator 변환 파서 작성}
    \resumeItemListEnd
